    ...
    <div class="bg-gray-800 bg-opacity-75">
        <div class="container mx-auto py-4 flex flex-wrap flex-col sm:flex-row">
            <p class="text-gray-400 text-sm text-center sm:text-left">
                © 2021 McQueenCars —
                <a
                    href="https://github.com/LeBulbasaur"
                    rel="noopener noreferrer"
                    class="text-gray-500 ml-1"
                    target="_blank">@LeBulbasaur</a
                >
            </p>
            <span
            ...
            >
                <a
                    class="text-gray-400"
                    href="https://www.facebook.com/profile.php?id=100012331628700"
                >
                    <svg
                        fill="currentColor"
                ...
                <a
                    ...
                    href="https://twitter.com/AntoniZaremba"
                >
                    <svg
                        fill="currentColor"
                        stroke-linecap="round"
                ...
                <a
                    class="ml-3 text-gray-400"
                    href="https://www.instagram.com/owocowa_alpaka/"
                >
                    <svg
                        fill="none"
                        stroke="currentColor"
